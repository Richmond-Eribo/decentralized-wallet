    ...
    <div className=''>
      <div className='mx-auto '>
        <div className='text-cool-gray-500' id='about'>
          <h1 className='container flex justify-center mt-20 text-4xl font-semibold dark:text-white'>
            Wallet Integrate
          </h1>

          <div className='mx-8 mt-8'>
            <h2 className='flex justify-center text-3xl font-thin text-center dark:text-white'>
        ...
        <div id='github' className='flex sm:flex-row sm:justify-center'>
          <div className='flex flex-col mx-6 mt-16 font-thin text-gray-700 sm:flex-row sm:mx-8 sm:space-x-16 sm:max-w-sxl'>
            <div className='sm:w-1/2'>
              <h2 className='flex text-base font-semibold text-black dark:text-white'>
                What is Wallet Integrate
                <div className='ml-1 animate-bounce'>?</div>
              </h2>
              <p className='mt-6 text-lg text-black leading- dark:text-white'>
                ...
                Dapp from their mobile phone, making WalletConnect wallets a
                safer choice compared to desktop or browser extension wallets.
              </p>
            </div>

            <div className='mt-16 sm:w-1/2 sm:mt-0'>
              <h2 className='flex text-base font-semibold text-black dark:text-white'>
                How does it work<div className='ml-1 animate-bounce'>?</div>
              </h2>
              <p className='mt-6 text-lg leading-6 text-black dark:text-white'>
        ...
        >
          <div className='flex justify-center'>
            <div className='max-w-3xl'>
              <h1 className='text-4xl font-medium text-cool-gray-500 dark:text-white'>
                Wallets
              </h1>
              <p className='mt-10 text-lg font-thin leading-6 text-gray-700 dark:text-white'>
            ...
            <div className='grid max-w-3xl grid-cols-3 gap-10 mt-2 sm:grid-cols-2 md:grid-cols-4'>
              {Wallets.map(wallet => (
                <Link href={'/wallets/' + wallet.name}>
                  <div className='flex flex-col group' key={wallet.name}>
                    <div className='flex justify-center'>
                    ...
                    <div className='flex justify-center mt-4 font-semibold text-black dark:text-white group-hover:text-blue-700'>
                      {wallet.name}
                    </div>
                  </div>
                </Link>
